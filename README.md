...
# Features
1. Population counts of Common nighthawks in the world, florida, and by county
2. Heatmaps showing distribution of population by county and state
...
# Note 
Unfortunately GITHUB doesn't allow me to upload the large file of observations in the world, but I was able to upload the raw data in the release tab. 
